package com.epam.webparsing.parser.saxparser;
...
public class SaxParserTest {
    ...
    @Test
    public void testSaxParserShouldReturnListOfEightTouristVouchersWhenEightTouristVoucersGivenAndAddInLIst() {
        ...
        List<TouristVoucher> actualVouchers =  saxParser.parse(givenPath);
