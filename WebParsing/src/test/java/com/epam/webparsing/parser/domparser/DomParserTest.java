package com.epam.webparsing.parser.domparser;
...
public class DomParserTest {
    ...
    @Test
    public void testDomParserShouldReturnListOfEightTouristVouchersWhenEightTouristVoucersGivenAndAddInLIst() {
        String givenPath = "file:T:\\Epam\\WebParsing\\src\\main\\resources\\vouchers.xml";
        List<TouristVoucher> givenVouchers = new ArrayList<>();
        Hotel hotel1 = new Hotel(4,2, Nutrition.HB,true,true);
        EventTouristVoucher touristVoucher1 = new EventTouristVoucher(2500,"Belarus", Transport.PLANE,hotel1,"20.06.2019-28.07.2019");
        ...
        List<TouristVoucher> actualVouchers =  domParser.parse(givenPath);
